...
export async function recordCompleted(
  ...
  // exactly as before. Bind as text[] and convert server-side; postgres.js can
  // otherwise double-encode JSON strings for unsafe($n::jsonb), producing a JSON
  // scalar string that violates the array CHECK.
